...
CCF_PLOT_CONTROLS_DIV = "input-max-components-div-"
LOG = "log-"
STORED_PV = "stored-pv-"
  ...
  def __init__(
      ...
      children=[
        ...
        html.Div(
          ...
          children=[
                  ...
                  children=[
                    ...
                    html.Div(
                      ...
                      children=[
                        html.Span(
                          className="name",
                          children="interactive lines selection",
                        ),
                        dcc.RadioItems(
                          ["on", "off"],
                          "off",
            ...
            html.Div(children=[html.P(children="hola")]),
          ],
        ),
        html.Details(
          [
    ...
    def compute_pv(d):
      ...
      with warnings.catch_warnings(record=True) as w:
        warnings.simplefilter("always")
        warnings.warn(
          "need to check that prominence vineyard succedeed enable the button correctly!"
        )
