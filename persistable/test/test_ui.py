...
def setup():
    ...
    default_params = {
        'n_clusters': 1,
        'start': [1.1182295907794053, 0.09969876992582069],
        'end': [2.2421354738977923, 0.0497231839883207]
    }
...
def ccf_vineyard_input_selection_radio_on_locator(page):
    return page.locator("div#ccf-plot-controls-div-.parameters div#display-lines-selection- :text('On')")
...
def pv_parameter_selection_radio_on_locator(page):
    return page.locator("div#pv-plot-controls-div-.parameters div#display-parameter-selection- :text('On')")
